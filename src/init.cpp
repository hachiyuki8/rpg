...
void init_maps() {
  Map initial(MAPS[0], MAPS[0][0].size() * TILE_SIZE,
  ...
  Object flower16("red flower", "", objectTextures[28], 0, ObjectType::OTHERS,
                  280, 585, 27, 27);
  ...
  Object flower17("white flower", "", objectTextures[2], 0, ObjectType::OTHERS,
                  320, 560, 25, 25);
  ...
  Object flower18("yellow flower", "", objectTextures[1], 0, ObjectType::OTHERS,
                  340, 595, 26, 26);
  ...
  Object flower19("blue flower", "", objectTextures[3], 0, ObjectType::OTHERS,
                  360, 535, 28, 28);
  ...
  Object flower20("red flower", "", objectTextures[28], 0, ObjectType::OTHERS,
                  420, 595, 25, 25);
  ...
  Map second(MAPS[1], MAPS[1][0].size() * TILE_SIZE, MAPS[1].size() * TILE_SIZE,
             TILE_SIZE);
...
void init_NPCs() {
  CharacterNPC npc1(npcTextures[0], NPCState::SHOP_NPC, 620, 360, 80, 80);
  NPCs.push_back(npc1);
